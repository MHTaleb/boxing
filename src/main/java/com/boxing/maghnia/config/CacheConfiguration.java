package com.boxing.maghnia.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.boxing.maghnia.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.boxing.maghnia.repository.UserRepository.USERS_BY_EMAIL_CACHE);
