...
import { BoxerComponent } from 'app/entities/boxer/boxer.component';
import { BoxerService } from 'app/entities/boxer/boxer.service';
import { Boxer } from 'app/shared/model/boxer.model';

describe('Component Tests', () => {
  describe('Boxer Management Component', () => {
    let comp: BoxerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BoxerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.boxers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
