  ...
  describe('Trainer Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrainerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trainers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
